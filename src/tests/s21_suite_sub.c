...
START_TEST(sub_32) {
  ...
  int our_result_status = s21_sub(decimal, decimal2, &decimal3);
  // 0000000000000000 0000000000000000  0000000000000000 0000000000000000
  // 1111111111111111 1111111111111111  0000000000000000 0000000000000001
  ck_assert_int_eq(decimal3.bits[0], 1);
...
START_TEST(sub_35) {
  ...
  ck_assert_int_eq(decimal3.bits[3], 524288);
  ck_assert_int_eq(our_result_status, true_result_status);
}
END_TEST
START_TEST(sub_36) {
  ...
  ck_assert_int_eq(decimal3.bits[2], 2147483648);
...
//////////////////////////////////////////////////////////////////////////////////
//
// Created by Дмитрий on 28.05.2023.
//
...
START_TEST(sub_22) {
    ...
    //set_sign_bit_for_decimal(&value_1, 1);
    set_bit(&value_1, index_sign_bit, 1);

    s21_decimal value_2 = {{286, 0, 0, 0}};
    set_exp_for_decimal(&value_2, 2);
    //set_sign_bit_for_decimal(&value_2, 1);
    set_bit(&value_2, index_sign_bit, 1);

    s21_decimal result = {0};
    s21_decimal check = {{156, 0, 0, 0}};
    set_exp_for_decimal(&check, 2);
...
START_TEST(sub_23) {
    ...
    set_exp_for_decimal(&check, 2);
    //set_sign_bit_for_decimal(&check, 1);
    set_bit(&check, index_sign_bit, 1);
    int return_value = s21_sub(value_1, value_2, &result);
    ck_assert_int_eq(s21_is_equal(result, check), 1);
    ck_assert_int_eq(return_value, 0);
}
...
Suite *suite_s21_sub(void) {
  ...
  tcase_add_test(tc23, sub_29);
  tcase_add_test(tc23, sub_30);
  tcase_add_test(tc23, sub_31);
  tcase_add_test(tc23, sub_32);
  tcase_add_test(tc23, sub_33);
  tcase_add_test(tc23, sub_34);
  tcase_add_test(tc23, sub_35);
  tcase_add_test(tc23, sub_36);
  tcase_add_test(tc23, sub_37);
  tcase_add_test(tc23, sub_38);
  tcase_add_test(tc23, sub_39);
  tcase_add_test(tc23, sub_40);
  tcase_add_test(tc23, sub_41);
  tcase_add_test(tc23, sub_42);
  tcase_add_test(tc23, sub_43);
  tcase_add_test(tc23, sub_44);
  tcase_add_test(tc23, sub_45);
  


  tcase_add_test(tc23, sub_0);
    ...
    tcase_add_test(tc23, sub_18);
    tcase_add_test(tc23, sub_19);
    tcase_add_test(tc23, sub_22);
    tcase_add_test(tc23, sub_23);
    tcase_add_test(tc23, sub_24);
    tcase_add_test(tc23, sub_25);
    tcase_add_test(tc23, sub_26);
    tcase_add_test(tc23, sub_28);

    tcase_add_test(tc23, s21_subTest1);
    tcase_add_test(tc23, s21_subTest2);
    tcase_add_test(tc23, s21_subTest3);
    tcase_add_test(tc23, s21_subTest4);
    tcase_add_test(tc23, s21_subTest5);
    tcase_add_test(tc23, s21_subTest6);
    tcase_add_test(tc23, s21_subTest7);
    tcase_add_test(tc23, s21_subTest8);
    tcase_add_test(tc23, s21_subTest9);
    tcase_add_test(tc23, s21_subTest10);
    tcase_add_test(tc23, s21_subTest11);
    tcase_add_test(tc23, s21_subTest12);
    tcase_add_test(tc23, s21_subTest13);
    tcase_add_test(tc23, s21_subTest14);
    tcase_add_test(tc23, s21_subTest16);
    tcase_add_test(tc23, s21_subTest18);
    tcase_add_test(tc23, s21_subTest23);
    tcase_add_test(tc23, s21_subTest24);
    tcase_add_test(tc23, s21_subTest25);
    tcase_add_test(tc23, s21_subTest26);
    tcase_add_test(tc23, s21_subTest27);
    tcase_add_test(tc23, s21_subTest28);
    tcase_add_test(tc23, s21_subTest29);
    tcase_add_test(tc23, s21_subTest31);
    tcase_add_test(tc23, s21_subTest33);

    tcase_add_test(tc23, s21_test_decimal_sub_simple_0);
    tcase_add_test(tc23, s21_test_decimal_sub_simple_1);
    tcase_add_test(tc23, s21_test_decimal_sub_simple_2);
    tcase_add_test(tc23, s21_test_decimal_sub_simple_3);

    tcase_add_test(tc23, s21_test_decimal_sub_simple_7);
    tcase_add_test(tc23, s21_test_decimal_sub_simple_8);
    tcase_add_test(tc23, s21_test_decimal_sub_simple_10);
    tcase_add_test(tc23, s21_test_decimal_sub_simple_11);

   tcase_add_test(tc23, sub_test_11);
   tcase_add_test(tc23, sub_test_12);
   tcase_add_test(tc23, sub_test_16);
   tcase_add_test(tc23, sub_test_17);
   tcase_add_test(tc23, sub_test_18);
   tcase_add_test(tc23, sub_test_19);
   tcase_add_test(tc23, sub_test_20);
   tcase_add_test(tc23, sub_test_21);
   tcase_add_test(tc23, s21_sub_int_22);
   tcase_add_test(tc23, s21_sub_int_23);
   tcase_add_test(tc23, s21_sub_int_24);
   tcase_add_test(tc23, s21_sub_int_25);
   tcase_add_test(tc23, s21_sub_int_26);
   tcase_add_test(tc23, s21_sub_inf_27);
   tcase_add_test(tc23, s21_sub_neg_inf_28);

    tcase_add_test(tc23, s21_sub_max_31);
    tcase_add_test(tc23, s21_sub_max_32);
    tcase_add_test(tc23, s21_sub_max_35);
